...
/* const requestURL = '/wp-content/themes/temaejemplo/json/data.json';
...
function displayBusiness(bus) {
    ...
    portrait.setAttribute('src',`/wp-content/themes/temaejemplo/${bus.img}` );
...
const requestData = '/wp-content/themes/temaejemplo/json/data.json';
...
function displaySpotlight(bus) {
    ...
    image.setAttribute('src',`/wp-content/themes/temaejemplo/${bus.img}`);
